   ...
   if(currentStep === 4){
    ...
    <div class="card">
        ...
        <div class="grid">
            ...
            <div class="form-group">
                <label>Amazon Dart</label>
                <select id="amazondart">
                    <option value="">Disabled</option>
                    <option value="X">Enabled</option>
                </select>
            </div>
  ...
  if(currentStep === 5){
    ...
    <div class="card">
        ...
        <div class="grid">
            ...
            <div class="form-group">
                <label>Waste Toner</label>
                <select id="wasteToner">
                    <option value="">Disabled</option>
                    <option value="X">Enabled</option>
                </select>
            </div>
            ...
            <div class="form-group">
                <label>Claim Order</label>
                <select id="claimOrder">
                    <option value="">Disabled</option>
                    <option value="X">Enabled</option>
                </select>
            </div>

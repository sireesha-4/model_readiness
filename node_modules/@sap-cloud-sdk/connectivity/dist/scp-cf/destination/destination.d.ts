 ...
 */
type FetchOptionsLeaf = Omit<DestinationFetchOptions, 'destinationName'> & DestinationFromServiceBindingOptions;
/**
 * Type that is either a {@link Destination} or (XOR) {@link DestinationFetchOptions} & {@link DestinationFromServiceBindingOptions}.
 */
export type DestinationOrFetchOptions = (WithoutExclusive<Destination, FetchOptionsLeaf> & FetchOptionsLeaf) | (WithoutExclusive<FetchOptionsLeaf, Destination> & Destination);
/**
 ...
 */
export type HttpDestinationOrFetchOptions = (WithoutExclusive<HttpDestination, FetchOptionsLeaf> & FetchOptionsLeaf) | (WithoutExclusive<FetchOptionsLeaf, HttpDestination> & HttpDestination);
export {};

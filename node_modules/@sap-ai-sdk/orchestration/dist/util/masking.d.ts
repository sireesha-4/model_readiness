import type { DpiMaskingProviderConfig, DpiMaskingConfig } from '../orchestration-types.ts';
/**
 ...
 */
export declare function buildDpiMaskingProvider(dpiMaskingConfig: DpiMaskingConfig): DpiMaskingProviderConfig;

...
import type { AssistantChatMessage, ChatMessages, CompletionPostResponse, LlmChoice, MessageToolCalls, ModuleResults, TokenUsage, Citation, Error as OrchestrationError } from './client/api/schema/index.ts';
...
export declare class OrchestrationStreamResponse<T> {
     ...
     */
    getReasoningContent(choiceIndex?: number): string[] | undefined;
    /**

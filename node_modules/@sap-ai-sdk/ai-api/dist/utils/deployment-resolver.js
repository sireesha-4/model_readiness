 ...
 * @internal
 */
export async function resolveDeploymentUrlById(deploymentId, resourceGroup, destination) {
 ...
 * @internal
 */
export async function resolveDeploymentUrlForModel(modelDeployment, options) {

...
export const PromptTemplatesApi = {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    listPromptTemplateHistory: (scenario, version, name, headerParameters, queryParameters) => new OpenApiRequestBuilder('get', '/lm/scenarios/{scenario}/promptTemplates/{name}/versions/{version}/history', {
